...
func TestVerifyOptionsDisabled(t *testing.T) {
	...
	_, err = sd.VerifyWithOptions(germanCertPool, nil)
	if err != nil {
		t.Fatalf("VerifyWithOptions with nil options should succeed: %v", err)
	}
	...
	if err != nil {
		t.Fatalf("VerifyWithOptions with CheckRevocation=false should succeed: %v", err)
	}

	t.Log("Verification succeeded with CRL checking disabled")
}

// TestVerifyOptionsBackwardCompatibility tests that the old Verify method still works
func TestVerifyOptionsBackwardCompatibility(t *testing.T) {
	// Use German passport SignedData
	signedDataBytes := utils.HexToBytes("")
	...
	// Test the deprecated Verify method still works
	_, err = sd.Verify(germanCertPool)
	if err != nil {
		t.Fatalf("Backward compatible Verify method should still work: %v", err)
	}

	t.Log("Backward compatible Verify method works correctly")
}
